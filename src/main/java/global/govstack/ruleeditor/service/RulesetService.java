...
public class RulesetService {
    ...
    // Form/table names
    private static final String RULESET_FORM = "ruleset";
    private static final String RULESET_TABLE = "ruleset";
    ...
    public String saveRuleset(String rulesetCode, String rulesetName, String script,
        ...
        try {
            ...
            if (isNew) {
                ...
                rulesetCode = "RS-" + contextType.substring(0, 4) + "-" + timestamp + "-" + uuid;
    ...
    /**
     * Load raw FormRow for a ruleset.
     */
    private FormRow loadRulesetRow(String rulesetCode) {
        try {
            ...
            FormRow row = formDataDao.loadWithoutTransaction(RULESET_FORM, RULESET_TABLE, rulesetCode);
            return row;
    ...
    private RulesetData rowToRulesetData(FormRow row) {
        ...
        data.setScript((String) row.getProperty("script"));
        data.setStatus((String) row.getProperty("status"));
        data.setVersion((String) row.getProperty("version"));
